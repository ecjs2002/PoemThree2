...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.djpack).into(iv);
        logo= (ImageView) findViewById(R.id.logo);
        Glide.with(this).load(R.drawable.logosunden).into(logo);
        ...
        finish.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN){
                    finish.setColorFilter(0xaa111111);

                }else if(event.getAction()==MotionEvent.ACTION_UP){
                    finish.setColorFilter(0x00000000);
                }
